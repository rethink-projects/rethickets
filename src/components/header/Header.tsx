        ...
        <div className="container-header">
          ...
          >
            <div className="modal">
              ...
              <Logo />
              <h1 className="modal-body-text">Faça login e participe dos nossos principais eventos!
              </h1>
              </div>
              ...
              <div className="modal-footer">
                ...
                <input type="text" placeholder="Digite seu nome:" className="modal-input"/>

                <input type="password" placeholder="Digite sua senha:" className="modal-input"/>
